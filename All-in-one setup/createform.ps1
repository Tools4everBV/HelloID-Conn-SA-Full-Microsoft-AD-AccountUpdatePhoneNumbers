...
<# Begin: DataSource "AD Account - Update Phonenumber & Mobile | AD-Get-All-Users-Wildcard-Name-DisplayName-UPN-Mail" #>
$tmpPsScript = @'
...
'@ 
$tmpModel = @'
[{"key":"ObjectGuid","type":0},{"key":"SamAccountName","type":0},{"key":"DisplayName","type":0},{"key":"UserPrincipalName","type":0},{"key":"Enabled","type":0},{"key":"LockedOut","type":0},{"key":"Description","type":0},{"key":"Company","type":0},{"key":"Department","type":0},{"key":"Title","type":0},{"key":"Mobile","type":0},{"key":"TelephoneNumber","type":0}]
'@ 
$tmpInput = @'
...
AD Account - Update Phonenumber & Mobile | AD-Get-All-Users-Wildcard-Name-DisplayName-UPN-Mail
'@ 
...
<# End: DataSource "AD Account - Update Phonenumber & Mobile | AD-Get-All-Users-Wildcard-Name-DisplayName-UPN-Mail" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "AD Account - Update Phonenumber & Mobile" #>
$tmpSchema = @"
[{"label":"Select user account","fields":[{"key":"searchValue","templateOptions":{"label":"Search (wildcard search in Name, Display name, UserPrincipalName and Mail)","placeholder":"Name, Display name, UserPrincipalName or Mail (use * to search all users)","required":true,"minLength":1},"type":"input","summaryVisibility":"Hide element","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false},{"key":"gridUsers","templateOptions":{"label":"Select user","required":true,"grid":{"columns":[{"headerName":"Display Name","field":"DisplayName"},{"headerName":"User Principal Name","field":"UserPrincipalName"},{"headerName":"Mobile","field":"Mobile"},{"headerName":"TelephoneNumber","field":"TelephoneNumber"}],"height":300,"rowSelection":"single"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[{"propertyName":"searchValue","otherFieldValue":{"otherFieldKey":"searchValue"}}]}},"useFilter":true,"allowCsvDownload":true},"type":"grid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":true}]},{"label":"Update Mobile","fields":[{"key":"mobile","templateOptions":{"label":"Mobile","pattern":"^\\+316\\d{8}$","useDependOn":true,"dependOn":"gridUsers","dependOnProperty":"Mobile"},"type":"input","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false},{"key":"telephoneNumber","templateOptions":{"label":"TelephoneNumber","useDependOn":true,"dependOn":"gridUsers","dependOnProperty":"TelephoneNumber","pattern":"^\\+3188220\\d{4}$","placeholder":"+3188220...."},"type":"input","defaultValue":"+3188220","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false}]}]
"@ 

$dynamicFormGuid = [PSCustomObject]@{} 
$dynamicFormName = @'
AD Account - Update Phonenumber & Mobile
'@ 
